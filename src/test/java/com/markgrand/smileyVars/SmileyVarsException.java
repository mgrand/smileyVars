...
public class SmileyVarsException extends RuntimeException {
     ...
     * associated with {@code cause} is <i>not</i> automatically incorporated in this exception's detail
     * message.
     *
     ...
     * @since 1.4
     */
    SmileyVarsException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    SmileyVarsException(Throwable cause) {
        super(cause);
    }
}
