...
public class MockConnection implements Connection {
    ...
    public MockConnection metaData(DatabaseMetaData value) {
     ...
     * @throws SQLException SQLException if a database access error occurs or this method is called on a closed
     *                      connection
     */
    @Override
     ...
     * <p>
     * You must set the the values for the <code>TypeMap</code> prior to calling <code>setMap</code> as a JDBC driver may
     ...
     * @throws SQLException                    if a database access error occurs, this method is called on a closed
     *                                         connection or the given parameter is not a <code>java.util.Map</code>
     *                                         object
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
     * @see #getTypeMap
     * @since 1.2
     ...
     * by invoking {@link DatabaseMetaData#getResultSetHoldability}.
     *
     * @param holdability a <code>ResultSet</code> holdability constant; one of
     *                    <code>ResultSet.HOLD_CURSORS_OVER_COMMIT</code> or
     *                    <code>ResultSet.CLOSE_CURSORS_AT_COMMIT</code>
     * @throws SQLException                    if a database access occurs, this method is called on a closed
     *                                         connection, or the given parameter is not a <code>ResultSet</code>
     ...
     * @throws SQLException                    if a database access error occurs, this method is called while
     *                                         participating in a distributed transaction, this method is called on a
     *                                         closed connection, the <code>Savepoint</code> object is no longer valid,
     ...
     *                                         constructed, this method is called on a closed connection or a database
     *                                         access error occurs.
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this data type
     * @since 1.6
     */
     ...
     *                                         typeName and the conversion is not supported, the typeName is null or
     ...
     *                      If the timeout period expires before the operation completes, a SQLException will be thrown.
     *                     A value of 0 indicates that there is not timeout for database operations.
     * @throws SQLException                    if a database access error occurs, this method is called on a closed
     *                                         connection, the {@code executor} is {@code null}, or the value specified
     *                                         for <code>seconds</code> is less than 0.
     * @throws SecurityException               if a security manager exists and its
     *                                         <code>checkPermission</code> method denies calling
     *                                         <code>setNetworkTimeout</code>.
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
