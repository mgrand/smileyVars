...
public class MockDataSource implements DataSource {
     ...
     * @throws SQLTimeoutException when the driver has determined that the timeout value specified by the {@code
     *                             setLoginTimeout} method has been exceeded and has at least tried to cancel the
    ...
    public MockDataSource connection(Connection value) {
        connection = value;
        return this;
    }
     ...
     * and tracing messages for this data source will be printed.  This includes messages printed by the methods of this
     * object, messages printed by methods of other objects manufactured by this object, and so on.  Messages printed to
     * a data source specific log writer are not printed to the log writer associated with the
     ...
     * while attempting to connect to a database.  A value of zero specifies that the timeout is the default system
     * timeout if there is one; otherwise, it specifies that there is no timeout. When a <code>DataSource</code> object
