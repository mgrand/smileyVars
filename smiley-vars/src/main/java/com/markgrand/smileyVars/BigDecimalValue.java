...
/**
 * Class to represent a BigDecimal value that will be used to set the value of prepared statement parameter.
 *
 * @author Mark Grand
 */
class BigDecimalValue extends AbstactPreparedStatementValue {
