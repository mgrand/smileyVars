...
public class SmileyVarsPreparedStatement {
     ...
     */
    public SmileyVarsPreparedStatement(@NotNull Connection conn, @NotNull String sql) {
     ...
     * object; <code>false</code> if it is an update count or there are no results
     * @throws SQLException                    if a database access error occurs, this method is called on a closed
     *                                         <code>Statement</code>, the elements in the <code>int</code> array passed
    ...
    /**
     * Specifies that this {@code Statement} will be closed when all its dependent result sets are closed. If execution
     * of the {@code Statement} does not produce any result sets, this method has no effect.
     * <p>
     * <strong>Note:</strong> Multiple calls to {@code closeOnCompletion} do
     * not toggle the effect on this {@code Statement}. However, a call to {@code closeOnCompletion} does effect both
     * the subsequent execution of statements, and statements that currently have open, dependent, result sets.
     *
    ...
    /**
     * Returns a value indicating whether this {@code Statement} will be closed when all its dependent result sets are
     * closed.
     *
     * @return {@code true} if the {@code Statement} will be closed when all of its dependent result sets are closed;
